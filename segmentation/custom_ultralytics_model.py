...
class SegmentationModel(nn.Module):
    def __init__(self):
        ...
        # self.c2f2 = C2f(64, 128)
        # self.conv4 = Conv(64, 128)
        # self.c2f3 = C2f(128, 192)
        # self.conv5 = Conv(128, 256)
        # self.c2f4 = C2f(256, 384)
        # self.sppf = SPPF(256, 512)
        # self.upsample = nn.Upsample(scale_factor=2, mode='nearest')
        # self.concat1 = Concat()
        # self.c2f5 = C2f(192, 192)
        # self.upsample2 = nn.Upsample(scale_factor=2, mode='nearest')
        # self.c2f6 = C2f(128, 128)
        # self.upsample3 = nn.Upsample(scale_factor=2, mode='nearest')
        # self.c2f7 = C2f(48, 48)
        # self.conv6 = Conv(48, 64)
        # self.segment = Segment(64, 1)
    ...
    def forward(self, x):
        ...
        # x16 = self.c2f6(x15)
        # x17 = self.upsample3(x16)
        # x18 = torch.cat((x17, x3), dim=1)
        # x19 = self.c2f7(x18)
        # x20 = self.conv6(x19)
        # x21 = self.segment(x20)
        return self.model(x)
