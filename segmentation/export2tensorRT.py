...
model_path = '/home/curtis/classes/robotic_vision/racing/runs/segment/train2/weights/best.pt'
...
# success = model.export(format='engine', device='0', half=True, imgsz=160)
